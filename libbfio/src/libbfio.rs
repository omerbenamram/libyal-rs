...
pub const LIBBFIO_HAVE_MULTI_THREAD_SUPPORT: u32 = 1;
...
pub const LIBBFIO_VERSION: u32 = 20190127;
pub const LIBBFIO_VERSION_STRING: &'static [u8; 9usize] = b"20190127\0";
pub const LIBBFIO_POOL_UNLIMITED_NUMBER_OF_OPEN_HANDLES: u32 = 0;
...
pub type libbfio_handle_t = isize;
pub type libbfio_pool_t = isize;
pub const LIBBFIO_FLAGS_LIBBFIO_FLAG_IO_HANDLE_NON_MANAGED: LIBBFIO_FLAGS = 0;
pub const LIBBFIO_FLAGS_LIBBFIO_FLAG_IO_HANDLE_MANAGED: LIBBFIO_FLAGS = 1;
pub const LIBBFIO_FLAGS_LIBBFIO_FLAG_IO_HANDLE_CLONE_BY_FUNCTION: LIBBFIO_FLAGS = 0;
pub const LIBBFIO_FLAGS_LIBBFIO_FLAG_IO_HANDLE_CLONE_BY_REFERENCE: LIBBFIO_FLAGS = 2;
pub type LIBBFIO_FLAGS = u32;
pub const LIBBFIO_ACCESS_FLAGS_LIBBFIO_ACCESS_FLAG_READ: LIBBFIO_ACCESS_FLAGS = 1;
pub const LIBBFIO_ACCESS_FLAGS_LIBBFIO_ACCESS_FLAG_WRITE: LIBBFIO_ACCESS_FLAGS = 2;
pub const LIBBFIO_ACCESS_FLAGS_LIBBFIO_ACCESS_FLAG_TRUNCATE: LIBBFIO_ACCESS_FLAGS = 4;
pub type LIBBFIO_ACCESS_FLAGS = u32;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_ASCII: LIBBFIO_CODEPAGES = 20127;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_ISO_8859_1: LIBBFIO_CODEPAGES = 28591;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_ISO_8859_2: LIBBFIO_CODEPAGES = 28592;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_ISO_8859_3: LIBBFIO_CODEPAGES = 28593;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_ISO_8859_4: LIBBFIO_CODEPAGES = 28594;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_ISO_8859_5: LIBBFIO_CODEPAGES = 28595;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_ISO_8859_6: LIBBFIO_CODEPAGES = 28596;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_ISO_8859_7: LIBBFIO_CODEPAGES = 28597;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_ISO_8859_8: LIBBFIO_CODEPAGES = 28598;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_ISO_8859_9: LIBBFIO_CODEPAGES = 28599;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_ISO_8859_10: LIBBFIO_CODEPAGES = 28600;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_ISO_8859_11: LIBBFIO_CODEPAGES = 28601;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_ISO_8859_13: LIBBFIO_CODEPAGES = 28603;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_ISO_8859_14: LIBBFIO_CODEPAGES = 28604;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_ISO_8859_15: LIBBFIO_CODEPAGES = 28605;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_ISO_8859_16: LIBBFIO_CODEPAGES = 28606;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_KOI8_R: LIBBFIO_CODEPAGES = 20866;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_KOI8_U: LIBBFIO_CODEPAGES = 21866;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_WINDOWS_874: LIBBFIO_CODEPAGES = 874;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_WINDOWS_932: LIBBFIO_CODEPAGES = 932;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_WINDOWS_936: LIBBFIO_CODEPAGES = 936;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_WINDOWS_949: LIBBFIO_CODEPAGES = 949;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_WINDOWS_950: LIBBFIO_CODEPAGES = 950;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_WINDOWS_1250: LIBBFIO_CODEPAGES = 1250;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_WINDOWS_1251: LIBBFIO_CODEPAGES = 1251;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_WINDOWS_1252: LIBBFIO_CODEPAGES = 1252;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_WINDOWS_1253: LIBBFIO_CODEPAGES = 1253;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_WINDOWS_1254: LIBBFIO_CODEPAGES = 1254;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_WINDOWS_1255: LIBBFIO_CODEPAGES = 1255;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_WINDOWS_1256: LIBBFIO_CODEPAGES = 1256;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_WINDOWS_1257: LIBBFIO_CODEPAGES = 1257;
pub const LIBBFIO_CODEPAGES_LIBBFIO_CODEPAGE_WINDOWS_1258: LIBBFIO_CODEPAGES = 1258;
pub type LIBBFIO_CODEPAGES = u32;
pub type libbfio_error_t = isize;
pub const LIBBFIO_ERROR_DOMAINS_LIBBFIO_ERROR_DOMAIN_ARGUMENTS: LIBBFIO_ERROR_DOMAINS = 97;
pub const LIBBFIO_ERROR_DOMAINS_LIBBFIO_ERROR_DOMAIN_CONVERSION: LIBBFIO_ERROR_DOMAINS = 99;
pub const LIBBFIO_ERROR_DOMAINS_LIBBFIO_ERROR_DOMAIN_COMPRESSION: LIBBFIO_ERROR_DOMAINS = 67;
pub const LIBBFIO_ERROR_DOMAINS_LIBBFIO_ERROR_DOMAIN_IO: LIBBFIO_ERROR_DOMAINS = 73;
pub const LIBBFIO_ERROR_DOMAINS_LIBBFIO_ERROR_DOMAIN_INPUT: LIBBFIO_ERROR_DOMAINS = 105;
pub const LIBBFIO_ERROR_DOMAINS_LIBBFIO_ERROR_DOMAIN_MEMORY: LIBBFIO_ERROR_DOMAINS = 109;
pub const LIBBFIO_ERROR_DOMAINS_LIBBFIO_ERROR_DOMAIN_OUTPUT: LIBBFIO_ERROR_DOMAINS = 111;
pub const LIBBFIO_ERROR_DOMAINS_LIBBFIO_ERROR_DOMAIN_RUNTIME: LIBBFIO_ERROR_DOMAINS = 114;
pub type LIBBFIO_ERROR_DOMAINS = u32;
pub const LIBBFIO_ARGUMENT_ERROR_LIBBFIO_ARGUMENT_ERROR_GENERIC: LIBBFIO_ARGUMENT_ERROR = 0;
pub const LIBBFIO_ARGUMENT_ERROR_LIBBFIO_ARGUMENT_ERROR_INVALID_VALUE: LIBBFIO_ARGUMENT_ERROR = 1;
pub const LIBBFIO_ARGUMENT_ERROR_LIBBFIO_ARGUMENT_ERROR_VALUE_LESS_THAN_ZERO:
    LIBBFIO_ARGUMENT_ERROR = 2;
pub const LIBBFIO_ARGUMENT_ERROR_LIBBFIO_ARGUMENT_ERROR_VALUE_ZERO_OR_LESS: LIBBFIO_ARGUMENT_ERROR =
    3;
pub const LIBBFIO_ARGUMENT_ERROR_LIBBFIO_ARGUMENT_ERROR_VALUE_EXCEEDS_MAXIMUM:
    LIBBFIO_ARGUMENT_ERROR = 4;
pub const LIBBFIO_ARGUMENT_ERROR_LIBBFIO_ARGUMENT_ERROR_VALUE_TOO_SMALL: LIBBFIO_ARGUMENT_ERROR = 5;
pub const LIBBFIO_ARGUMENT_ERROR_LIBBFIO_ARGUMENT_ERROR_VALUE_TOO_LARGE: LIBBFIO_ARGUMENT_ERROR = 6;
pub const LIBBFIO_ARGUMENT_ERROR_LIBBFIO_ARGUMENT_ERROR_VALUE_OUT_OF_BOUNDS:
    LIBBFIO_ARGUMENT_ERROR = 7;
pub const LIBBFIO_ARGUMENT_ERROR_LIBBFIO_ARGUMENT_ERROR_UNSUPPORTED_VALUE: LIBBFIO_ARGUMENT_ERROR =
    8;
pub const LIBBFIO_ARGUMENT_ERROR_LIBBFIO_ARGUMENT_ERROR_CONFLICTING_VALUE: LIBBFIO_ARGUMENT_ERROR =
    9;
pub type LIBBFIO_ARGUMENT_ERROR = u32;
pub const LIBBFIO_CONVERSION_ERROR_LIBBFIO_CONVERSION_ERROR_GENERIC: LIBBFIO_CONVERSION_ERROR = 0;
pub const LIBBFIO_CONVERSION_ERROR_LIBBFIO_CONVERSION_ERROR_INPUT_FAILED: LIBBFIO_CONVERSION_ERROR =
    1;
pub const LIBBFIO_CONVERSION_ERROR_LIBBFIO_CONVERSION_ERROR_OUTPUT_FAILED:
    LIBBFIO_CONVERSION_ERROR = 2;
pub type LIBBFIO_CONVERSION_ERROR = u32;
pub const LIBBFIO_COMPRESSION_ERROR_LIBBFIO_COMPRESSION_ERROR_GENERIC: LIBBFIO_COMPRESSION_ERROR =
    0;
pub const LIBBFIO_COMPRESSION_ERROR_LIBBFIO_COMPRESSION_ERROR_COMPRESS_FAILED:
    LIBBFIO_COMPRESSION_ERROR = 1;
pub const LIBBFIO_COMPRESSION_ERROR_LIBBFIO_COMPRESSION_ERROR_DECOMPRESS_FAILED:
    LIBBFIO_COMPRESSION_ERROR = 2;
pub type LIBBFIO_COMPRESSION_ERROR = u32;
pub const LIBBFIO_IO_ERROR_LIBBFIO_IO_ERROR_GENERIC: LIBBFIO_IO_ERROR = 0;
pub const LIBBFIO_IO_ERROR_LIBBFIO_IO_ERROR_OPEN_FAILED: LIBBFIO_IO_ERROR = 1;
pub const LIBBFIO_IO_ERROR_LIBBFIO_IO_ERROR_CLOSE_FAILED: LIBBFIO_IO_ERROR = 2;
pub const LIBBFIO_IO_ERROR_LIBBFIO_IO_ERROR_SEEK_FAILED: LIBBFIO_IO_ERROR = 3;
pub const LIBBFIO_IO_ERROR_LIBBFIO_IO_ERROR_READ_FAILED: LIBBFIO_IO_ERROR = 4;
pub const LIBBFIO_IO_ERROR_LIBBFIO_IO_ERROR_WRITE_FAILED: LIBBFIO_IO_ERROR = 5;
pub const LIBBFIO_IO_ERROR_LIBBFIO_IO_ERROR_ACCESS_DENIED: LIBBFIO_IO_ERROR = 6;
pub const LIBBFIO_IO_ERROR_LIBBFIO_IO_ERROR_INVALID_RESOURCE: LIBBFIO_IO_ERROR = 7;
pub const LIBBFIO_IO_ERROR_LIBBFIO_IO_ERROR_IOCTL_FAILED: LIBBFIO_IO_ERROR = 8;
pub const LIBBFIO_IO_ERROR_LIBBFIO_IO_ERROR_UNLINK_FAILED: LIBBFIO_IO_ERROR = 9;
pub type LIBBFIO_IO_ERROR = u32;
pub const LIBBFIO_INPUT_ERROR_LIBBFIO_INPUT_ERROR_GENERIC: LIBBFIO_INPUT_ERROR = 0;
pub const LIBBFIO_INPUT_ERROR_LIBBFIO_INPUT_ERROR_INVALID_DATA: LIBBFIO_INPUT_ERROR = 1;
pub const LIBBFIO_INPUT_ERROR_LIBBFIO_INPUT_ERROR_SIGNATURE_MISMATCH: LIBBFIO_INPUT_ERROR = 2;
pub const LIBBFIO_INPUT_ERROR_LIBBFIO_INPUT_ERROR_CHECKSUM_MISMATCH: LIBBFIO_INPUT_ERROR = 3;
pub const LIBBFIO_INPUT_ERROR_LIBBFIO_INPUT_ERROR_VALUE_MISMATCH: LIBBFIO_INPUT_ERROR = 4;
pub type LIBBFIO_INPUT_ERROR = u32;
pub const LIBBFIO_MEMORY_ERROR_LIBBFIO_MEMORY_ERROR_GENERIC: LIBBFIO_MEMORY_ERROR = 0;
pub const LIBBFIO_MEMORY_ERROR_LIBBFIO_MEMORY_ERROR_INSUFFICIENT: LIBBFIO_MEMORY_ERROR = 1;
pub const LIBBFIO_MEMORY_ERROR_LIBBFIO_MEMORY_ERROR_COPY_FAILED: LIBBFIO_MEMORY_ERROR = 2;
pub const LIBBFIO_MEMORY_ERROR_LIBBFIO_MEMORY_ERROR_SET_FAILED: LIBBFIO_MEMORY_ERROR = 3;
pub type LIBBFIO_MEMORY_ERROR = u32;
pub const LIBBFIO_OUTPUT_ERROR_LIBBFIO_OUTPUT_ERROR_GENERIC: LIBBFIO_OUTPUT_ERROR = 0;
pub const LIBBFIO_OUTPUT_ERROR_LIBBFIO_OUTPUT_ERROR_INSUFFICIENT_SPACE: LIBBFIO_OUTPUT_ERROR = 1;
pub type LIBBFIO_OUTPUT_ERROR = u32;
pub const LIBBFIO_RUNTIME_ERROR_LIBBFIO_RUNTIME_ERROR_GENERIC: LIBBFIO_RUNTIME_ERROR = 0;
pub const LIBBFIO_RUNTIME_ERROR_LIBBFIO_RUNTIME_ERROR_VALUE_MISSING: LIBBFIO_RUNTIME_ERROR = 1;
pub const LIBBFIO_RUNTIME_ERROR_LIBBFIO_RUNTIME_ERROR_VALUE_ALREADY_SET: LIBBFIO_RUNTIME_ERROR = 2;
pub const LIBBFIO_RUNTIME_ERROR_LIBBFIO_RUNTIME_ERROR_INITIALIZE_FAILED: LIBBFIO_RUNTIME_ERROR = 3;
pub const LIBBFIO_RUNTIME_ERROR_LIBBFIO_RUNTIME_ERROR_RESIZE_FAILED: LIBBFIO_RUNTIME_ERROR = 4;
pub const LIBBFIO_RUNTIME_ERROR_LIBBFIO_RUNTIME_ERROR_FINALIZE_FAILED: LIBBFIO_RUNTIME_ERROR = 5;
pub const LIBBFIO_RUNTIME_ERROR_LIBBFIO_RUNTIME_ERROR_GET_FAILED: LIBBFIO_RUNTIME_ERROR = 6;
pub const LIBBFIO_RUNTIME_ERROR_LIBBFIO_RUNTIME_ERROR_SET_FAILED: LIBBFIO_RUNTIME_ERROR = 7;
pub const LIBBFIO_RUNTIME_ERROR_LIBBFIO_RUNTIME_ERROR_APPEND_FAILED: LIBBFIO_RUNTIME_ERROR = 8;
pub const LIBBFIO_RUNTIME_ERROR_LIBBFIO_RUNTIME_ERROR_COPY_FAILED: LIBBFIO_RUNTIME_ERROR = 9;
pub const LIBBFIO_RUNTIME_ERROR_LIBBFIO_RUNTIME_ERROR_REMOVE_FAILED: LIBBFIO_RUNTIME_ERROR = 10;
pub const LIBBFIO_RUNTIME_ERROR_LIBBFIO_RUNTIME_ERROR_PRINT_FAILED: LIBBFIO_RUNTIME_ERROR = 11;
pub const LIBBFIO_RUNTIME_ERROR_LIBBFIO_RUNTIME_ERROR_VALUE_OUT_OF_BOUNDS: LIBBFIO_RUNTIME_ERROR =
    12;
pub const LIBBFIO_RUNTIME_ERROR_LIBBFIO_RUNTIME_ERROR_VALUE_EXCEEDS_MAXIMUM: LIBBFIO_RUNTIME_ERROR =
    13;
pub const LIBBFIO_RUNTIME_ERROR_LIBBFIO_RUNTIME_ERROR_UNSUPPORTED_VALUE: LIBBFIO_RUNTIME_ERROR = 14;
pub const LIBBFIO_RUNTIME_ERROR_LIBBFIO_RUNTIME_ERROR_ABORT_REQUESTED: LIBBFIO_RUNTIME_ERROR = 15;
pub type LIBBFIO_RUNTIME_ERROR = u32;
extern "C" {
    #[link_name = "\u{1}_libbfio_get_version"]
    pub fn libbfio_get_version() -> *const ::std::os::raw::c_char;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_get_codepage"]
    pub fn libbfio_get_codepage(
        codepage: *mut ::std::os::raw::c_int,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_set_codepage"]
    pub fn libbfio_set_codepage(
        codepage: ::std::os::raw::c_int,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_error_free"]
    pub fn libbfio_error_free(error: *mut *mut libbfio_error_t);
}
extern "C" {
    #[link_name = "\u{1}_libbfio_error_fprint"]
    pub fn libbfio_error_fprint(
        error: *mut libbfio_error_t,
        stream: *mut FILE,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_error_sprint"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_error_backtrace_fprint"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_error_backtrace_sprint"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_initialize"]
    pub fn libbfio_handle_initialize(
        handle: *mut *mut libbfio_handle_t,
        io_handle: *mut isize,
        free_io_handle: ::std::option::Option<
            unsafe extern "C" fn(
                io_handle: *mut *mut isize,
                error: *mut *mut libbfio_error_t,
            ) -> ::std::os::raw::c_int,
        >,
        clone_io_handle: ::std::option::Option<
            unsafe extern "C" fn(
                destination_io_handle: *mut *mut isize,
        ...
        >,
        exists: ::std::option::Option<
            unsafe extern "C" fn(
                io_handle: *mut isize,
                error: *mut *mut libbfio_error_t,
            ) -> ::std::os::raw::c_int,
        >,
        is_open: ::std::option::Option<
            unsafe extern "C" fn(
                io_handle: *mut isize,
                error: *mut *mut libbfio_error_t,
            ) -> ::std::os::raw::c_int,
        >,
        get_size: ::std::option::Option<
            unsafe extern "C" fn(
                io_handle: *mut isize,
                size: *mut size64_t,
                error: *mut *mut libbfio_error_t,
...
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_free"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_clone"]
    pub fn libbfio_handle_clone(
        destination_handle: *mut *mut libbfio_handle_t,
        source_handle: *mut libbfio_handle_t,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_open"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_reopen"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_close"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_read_buffer"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_write_buffer"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_seek_offset"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_exists"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_is_open"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_get_io_handle"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_get_access_flags"]
    pub fn libbfio_handle_get_access_flags(
        handle: *mut libbfio_handle_t,
        access_flags: *mut ::std::os::raw::c_int,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_set_access_flags"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_get_offset"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_get_size"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_set_open_on_demand"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_set_track_offsets_read"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_get_number_of_offsets_read"]
    pub fn libbfio_handle_get_number_of_offsets_read(
        handle: *mut libbfio_handle_t,
        number_of_read_offsets: *mut ::std::os::raw::c_int,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_handle_get_offset_read"]
...
extern "C" {
    #[link_name = "\u{1}_libbfio_file_initialize"]
    pub fn libbfio_file_initialize(
        handle: *mut *mut libbfio_handle_t,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_file_get_name_size"]
    pub fn libbfio_file_get_name_size(
        handle: *mut libbfio_handle_t,
        name_size: *mut usize,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    #[link_name = "\u{1}_libbfio_file_get_name"]
    pub fn libbfio_file_get_name(
        handle: *mut libbfio_handle_t,
...
extern "C" {
    #[link_name = "\u{1}_libbfio_file_set_name"]
    pub fn libbfio_file_set_name(
        handle: *mut libbfio_handle_t,
...
extern "C" {
    #[link_name = "\u{1}_libbfio_file_range_initialize"]
    pub fn libbfio_file_range_initialize(
        handle: *mut *mut libbfio_handle_t,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_file_range_get_name_size"]
    pub fn libbfio_file_range_get_name_size(
        handle: *mut libbfio_handle_t,
        name_size: *mut usize,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    #[link_name = "\u{1}_libbfio_file_range_get_name"]
    pub fn libbfio_file_range_get_name(
        handle: *mut libbfio_handle_t,
        name: *mut ::std::os::raw::c_char,
        name_size: usize,
        error: *mut *mut libbfio_error_t,
...
extern "C" {
    #[link_name = "\u{1}_libbfio_file_range_set_name"]
    pub fn libbfio_file_range_set_name(
        handle: *mut libbfio_handle_t,
        name: *const ::std::os::raw::c_char,
        name_length: usize,
        error: *mut *mut libbfio_error_t,
...
extern "C" {
    #[link_name = "\u{1}_libbfio_file_range_get"]
    pub fn libbfio_file_range_get(
        handle: *mut libbfio_handle_t,
        range_offset: *mut off64_t,
        range_size: *mut size64_t,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_file_range_set"]
    pub fn libbfio_file_range_set(
        handle: *mut libbfio_handle_t,
        range_offset: off64_t,
        range_size: size64_t,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_memory_range_initialize"]
    pub fn libbfio_memory_range_initialize(
        handle: *mut *mut libbfio_handle_t,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_memory_range_get"]
    pub fn libbfio_memory_range_get(
        handle: *mut libbfio_handle_t,
        start: *mut *mut u8,
        size: *mut usize,
        error: *mut *mut libbfio_error_t,
...
extern "C" {
    #[link_name = "\u{1}_libbfio_memory_range_set"]
    pub fn libbfio_memory_range_set(
        handle: *mut libbfio_handle_t,
        start: *mut u8,
        size: usize,
        error: *mut *mut libbfio_error_t,
...
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_initialize"]
    pub fn libbfio_pool_initialize(
        pool: *mut *mut libbfio_pool_t,
        number_of_handles: ::std::os::raw::c_int,
        maximum_number_of_open_handles: ::std::os::raw::c_int,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_free"]
    pub fn libbfio_pool_free(
        pool: *mut *mut libbfio_pool_t,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_clone"]
    pub fn libbfio_pool_clone(
        destination_pool: *mut *mut libbfio_pool_t,
        source_pool: *mut libbfio_pool_t,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_resize"]
    pub fn libbfio_pool_resize(
        pool: *mut libbfio_pool_t,
        number_of_handles: ::std::os::raw::c_int,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_get_number_of_handles"]
    pub fn libbfio_pool_get_number_of_handles(
        pool: *mut libbfio_pool_t,
        number_of_handles: *mut ::std::os::raw::c_int,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_get_handle"]
    pub fn libbfio_pool_get_handle(
        pool: *mut libbfio_pool_t,
...
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_append_handle"]
    pub fn libbfio_pool_append_handle(
        pool: *mut libbfio_pool_t,
        entry: *mut ::std::os::raw::c_int,
        handle: *mut libbfio_handle_t,
        access_flags: ::std::os::raw::c_int,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_set_handle"]
    pub fn libbfio_pool_set_handle(
        pool: *mut libbfio_pool_t,
        entry: ::std::os::raw::c_int,
        handle: *mut libbfio_handle_t,
        access_flags: ::std::os::raw::c_int,
...
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_remove_handle"]
    pub fn libbfio_pool_remove_handle(
        pool: *mut libbfio_pool_t,
        entry: ::std::os::raw::c_int,
        handle: *mut *mut libbfio_handle_t,
        error: *mut *mut libbfio_error_t,
...
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_get_maximum_number_of_open_handles"]
    pub fn libbfio_pool_get_maximum_number_of_open_handles(
        pool: *mut libbfio_pool_t,
        maximum_number_of_open_handles: *mut ::std::os::raw::c_int,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_set_maximum_number_of_open_handles"]
    pub fn libbfio_pool_set_maximum_number_of_open_handles(
        pool: *mut libbfio_pool_t,
        maximum_number_of_open_handles: ::std::os::raw::c_int,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_open"]
    pub fn libbfio_pool_open(
        pool: *mut libbfio_pool_t,
        entry: ::std::os::raw::c_int,
        access_flags: ::std::os::raw::c_int,
        error: *mut *mut libbfio_error_t,
...
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_reopen"]
    pub fn libbfio_pool_reopen(
        pool: *mut libbfio_pool_t,
        entry: ::std::os::raw::c_int,
        access_flags: ::std::os::raw::c_int,
        error: *mut *mut libbfio_error_t,
...
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_close"]
    pub fn libbfio_pool_close(
        pool: *mut libbfio_pool_t,
        entry: ::std::os::raw::c_int,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_close_all"]
    pub fn libbfio_pool_close_all(
        pool: *mut libbfio_pool_t,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_read_buffer"]
    pub fn libbfio_pool_read_buffer(
        pool: *mut libbfio_pool_t,
        entry: ::std::os::raw::c_int,
        buffer: *mut u8,
        size: usize,
...
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_write_buffer"]
    pub fn libbfio_pool_write_buffer(
        pool: *mut libbfio_pool_t,
        entry: ::std::os::raw::c_int,
        buffer: *const u8,
        size: usize,
...
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_seek_offset"]
    pub fn libbfio_pool_seek_offset(
        pool: *mut libbfio_pool_t,
        entry: ::std::os::raw::c_int,
        offset: off64_t,
        whence: ::std::os::raw::c_int,
...
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_get_offset"]
    pub fn libbfio_pool_get_offset(
        pool: *mut libbfio_pool_t,
        entry: ::std::os::raw::c_int,
        offset: *mut off64_t,
        error: *mut *mut libbfio_error_t,
...
extern "C" {
    #[link_name = "\u{1}_libbfio_pool_get_size"]
    pub fn libbfio_pool_get_size(
        pool: *mut libbfio_pool_t,
        entry: ::std::os::raw::c_int,
        size: *mut size64_t,
        error: *mut *mut libbfio_error_t,
...
extern "C" {
    #[link_name = "\u{1}_libbfio_file_pool_append_handles_for_names"]
    pub fn libbfio_file_pool_append_handles_for_names(
        pool: *mut libbfio_pool_t,
        names: *const *mut ::std::os::raw::c_char,
        number_of_names: ::std::os::raw::c_int,
        access_flags: ::std::os::raw::c_int,
        error: *mut *mut libbfio_error_t,
    ) -> ::std::os::raw::c_int;
}
